...
//  Breezee
//
//  Created by iBreezeeFormal on 2016/11/1.
...
+(NSDate *)dateStringToDate:(NSString *)dateString withFormat:(NSString *)format{
    NSDateFormatter *dateFormatter = [[NSDateFormatter alloc] init];
    //设定时间格式,这里可以设置成自己需要的格式
...
- (BOOL) isYesterday {
    ...
    //NSLog(@"今天%@-----昨天%@----明天%@",[Util dateToString:[NSDate date]],[Util dateToString:[NSDate dateYesterday]],[Util dateToString:[NSDate dateTomorrow]]);
